...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        "pointer-events-none fixed inset-x-4 [--toast-top-offset:5rem] top-(--toast-top-offset) z-50 mx-auto w-auto max-w-sm outline-none sm:right-4 sm:left-auto sm:mx-0 sm:w-full",
        className,
      )}
      {...props}
    />
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        "data-limited:opacity-0 data-starting-style:opacity-0 data-ending-style:opacity-0 data-starting-style:[transform:translateY(calc(-100%-var(--toast-top-offset)-1rem))]",
        "[&[data-ending-style]:not([data-limited]):not([data-swipe-direction])]:[transform:translateY(calc(-100%-var(--toast-top-offset)-1rem))]",
        ...
        toastColors[props.toast.type ?? ""],
        props.toast.type &&
          toastColors[props.toast.type] &&
          "[&_[data-slot=toast-description]]:text-inherit [&_[data-slot=toast-description]]:opacity-80 [&_[data-slot=toast-close]]:text-inherit [&_[data-slot=toast-close]:hover]:bg-black/5 dark:[&_[data-slot=toast-close]:hover]:bg-white/10",
        className,
      )}
      {...props}
    />
